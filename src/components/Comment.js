...
const Comment = ({ comment, replies, currentUserId, deleteComment, activeComment,updateComment, setActiveComment, parentId = null, addComment }) => {
    ...
    <div className="comment">
      ...
      <div className="comment-right-part">
        ...
        <div className="comment-actions">
          ...
          {canDelete && <div className="comment-action" onClick={() => deleteComment(comment.id)}
          >Delete</div>}
